...
import { useAuth, signOut, useUser } from '@/firebase';
...
export function AppSidebar() {
  ...
  const navClass = (active: boolean) =>
    active
      ? 'bg-white text-black shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-full'
      : 'transition-colors hover:text-neutral-800 rounded-full';
