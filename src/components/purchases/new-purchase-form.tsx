  ...
  const onFinalizePurchase = async (values: z.infer<typeof purchaseSchema>) => {
    ...
    try {
      ...
      values.items.forEach((item) => {
        ...
        // 2b. Update product doc (if product not loaded yet, assume base stock 0)
                      ...
                      <FormControl>
                        <IMaskInput
                          ...
                          onAccept={(value: any) => {
                            ...
                            const y = Number(year);
                            const parsed = d && m && y ? new Date(y, m - 1, d) : null;
      ...
      <Form {...itemEntryForm}>
        <div className="space-y-4 rounded-lg border bg-slate-50 p-4">
                    ...
                    <div className="flex items-center rounded-lg border bg-white overflow-hidden">
                      ...
                      <FormControl>
                          <Input
                            type="number"
                            inputMode="numeric"
                            className="h-10 w-16 flex-1 border-0 rounded-none text-center bg-transparent focus-visible:ring-0 focus-visible:ring-offset-0"
                            {...field}
                          />
                      </FormControl>
                      <Button
            ...
            <div className="sm:col-span-1 lg:col-span-2">
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        ...
                        step="0.01"
                        {...field}
                        className="bg-slate-50 focus:ring-2 focus:ring-neutral-400 focus:border-transparent transition-all w-full"
                        placeholder="0,00"
                      />
                    </FormControl>
                    <FormMessage />
              ...
              <div className="flex items-end sm:col-span-2 lg:col-span-1 mt-1">
              <Button
                type="button"
                onClick={itemEntryForm.handleSubmit(onSubmit)}
                  className="w-full h-12 sm:h-12 rounded-full bg-emerald-600 hover:bg-emerald-700 text-white"
              >
                Adicionar à Lista
              </Button>
            </div>
