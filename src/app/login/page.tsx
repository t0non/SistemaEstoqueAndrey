...
export default function LoginPage() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      if (error.code === 'auth/email-not-confirmed') {
        toast({
          variant: 'destructive',
          title: 'Email não confirmado',
          description: 'Verifique sua caixa de entrada e confirme seu email para entrar.',
        });
        ...
        try {
          ...
          toast({
            ...
            description: 'Enviamos um email de confirmação. Confirme para fazer login.',
          });
